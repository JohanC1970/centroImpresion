...
public class CentroImpresionController implements Initializable{
	...
	/**
	 * Inicializa los datos previamente guardados
	 */
	@Override
	...
	*/
    ...
    /**
     * Este evento me permite desconectar una impresora
     * @param event
     */
    @FXML
    ...
    /**
     * Este metodo me permite crear una impresora
     * @param event
	...
	/**
	 * Este evento me permite eliminar una impresora seleccionada
	 * @param event
	 * @throws ImpresoraException
	 */
     @FXML
     ...
     /**
      * Este evento me peromite actualizar los textFiel de las impresoras
      * @param event
      */
     @FXML
     ...
     /**
      * Este evento me permite imprimir documentos
      * @param event
      * @throws ImpresoraException
      */
     @FXML
     void imprimirDocumentos(ActionEvent event) throws ImpresoraException {
    	 if(impresoraSeleccionada != null){
    		 if(impresoraSeleccionada.getEstado().equals("Conectada")){
    			 ...
    			 mostrarMensaje("Informacion impresora", "Error", "La impresora esta desconectada", AlertType.ERROR);
    		 }
    	}else{
    ...
    void agregarDocumentos(ActionEvent event) throws DocumentoException{
		if(txtDireccion.getText().equals("")){
			mostrarMensaje("Informacion documento", "Error", "Por favor seleccione un archivo txt", AlertType.ERROR);
		}
	...
	private void crearDocumento(String titulo, String texto, Integer prioridad) throws DocumentoException {
		...
		if(aplicacion.verificarExistenciaDocumento(titulo)){
			mostrarMensaje("Informacion documento", "Error","El documento ya existe", AlertType.ERROR);
		}
